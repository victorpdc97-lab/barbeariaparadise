      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col gap-4 mt-6">
          <a
            ...
            className="group flex items-center justify-center gap-3 px-6 py-4 bg-foreground text-background rounded-xl hover:scale-105 hover:shadow-lg transition-all duration-300 animate-[pulse_3s_ease-in-out_infinite]"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center justify-center gap-3 px-6 py-4 bg-foreground text-background rounded-xl hover:scale-105 hover:shadow-lg transition-all duration-300 animate-[pulse_3s_ease-in-out_infinite_0.5s]"
          >
            <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current group-hover:scale-110 transition-transform duration-300">
