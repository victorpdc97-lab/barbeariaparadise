      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col gap-4 mt-6">
          <a
            ...
            className="group flex items-center justify-center gap-3 px-6 py-4 bg-foreground text-background rounded-xl hover:scale-105 hover:shadow-lg transition-all duration-300 animate-[pulse_5s_ease-in-out_infinite]"
          >
