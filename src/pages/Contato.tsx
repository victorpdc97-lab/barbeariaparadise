                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <Input
                      ...
                      required
                      className="border-border bg-transparent focus:border-[hsl(var(--gold))] transition-colors"
                    />
                  </div>
                  <div>
                    <label htmlFor="phone" className="block text-xs font-medium text-muted-foreground mb-2 tracking-wide uppercase">
                      Telefone
                    </label>
                    <Input
                      id="phone"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-xs font-medium text-muted-foreground mb-2 tracking-wide uppercase">
                      Mensagem
                    </label>
                    <Textarea
                      id="message"
                      ...
                      onChange={handleChange}
                      rows={4}
                      className="border-border bg-transparent resize-none focus:border-[hsl(var(--gold))] transition-colors"
                    />
                  </div>
                  <button
                    type="submit"
              ...
              <div className="space-y-8">
                ...
                {[
                  ...
                  },
                  {
                    ...
                    title: "Telefone",
                    content: (
                      <a href="tel:+553186595481" className="text-sm text-muted-foreground hover:text-[hsl(var(--gold))] transition-colors">
                        (31) 98659-5481
                      </a>
                    ),
                  },
                ...
                {/* Map */}
                <div className="overflow-hidden h-[250px] rounded-lg mt-6">
                  <iframe
