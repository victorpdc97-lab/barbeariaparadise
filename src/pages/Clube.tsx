          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center opacity-0 animate-fade-up delay-300">
              <a
                ...
                className="group inline-flex items-center justify-center gap-3 px-6 py-4 bg-white text-foreground rounded-xl hover:bg-white/90 hover:scale-105 hover:shadow-lg hover:shadow-white/20 transition-all duration-300 animate-[pulse_15s_ease-in-out_infinite]"
              >
