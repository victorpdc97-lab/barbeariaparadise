      ...
      <section className="hero-section hero-gradient relative overflow-hidden">
        ...
        <div className="relative z-10 container-clean py-20 lg:py-32">
          <div className="max-w-3xl mx-auto text-center">
            <span className="inline-block px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-sm font-medium text-white mb-6 opacity-0 animate-fade-up">
              ✨ Clube Paradise
            </span>
        ...
        <div className="container-clean">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {plans.map((plan, index) => (
              <div
                key={plan.subtitle}
                className={`relative bg-card-light rounded-3xl p-8 border-2 transition-all hover:shadow-xl opacity-0 animate-fade-up ${
                  plan.featured 
              ...
              <div className="card-clean p-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {partners.map((partner) => (
                    <span 
                      key={partner} 
                      className="px-4 py-2 bg-background rounded-full text-sm text-foreground font-medium border border-border hover:border-primary/30 transition-colors"
                    >
                      {partner}
                    </span>
                  ))}
