...
const categories = [
  ...
  {
    title: "Tratamentos Faciais & Corporais",
    services: [
      ...
      <main className="pt-24">
        ...
        <section className="py-16 md:py-20 bg-foreground">
          <div className="container-narrow text-center">
            ...
            <p className="text-primary-foreground/60 text-sm max-w-md mx-auto">
              Cuide de você com nossos serviços de estética, massagem e bem-estar
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-foreground">
          <div className="container-narrow text-center">
            ...
            <a href={bookingLink} target="_blank" rel="noopener noreferrer" className="btn-primary">
              Agendar Horário
            </a>
          </div>
        </section>
